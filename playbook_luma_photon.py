...
#         url = f"https://accounts.playbook3d.com/upload-assets/{run_id}/{node_id}"
#         headers = {
...
#             "required": {
#                 "luma_api_key": ("STRING", {"multiline": False}),
#                 "api_key": ("STRING", {"multiline": False}),  # Added this
#                 "prompt": ("STRING", {"multiline": True, "default": ""}),
#                 "modify_image": ("IMAGE", {"forceInput": True}),  # Changed from URL to IMAGE
#                 "save": ("BOOLEAN", {"default": True}),
#             },
#             "optional": {
#                 "filename": ("STRING", {"default": ""}),
...
#     def run(self, luma_api_key, api_key, prompt, modify_image, save, filename=""):
#         if not prompt:
#             raise ValueError("Prompt is required")

#         # Upload the input image to S3 and get URL
#         modify_image_url = upload_image_to_s3(modify_image, api_key)
#         print(f"Debug - Image uploaded to S3: {modify_image_url}")

#         # Use the Luma API client
#         client = LumaAI(auth_token=luma_api_key)
...
class Playbook_PhotonModifyImage:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "filename": ("STRING", {"default": ""}),
                "run_id": ("STRING", {"default": ""})  # Added optional run_id
            },
        }
